...
export const translations: Translations = {
  ...
  hero_tagline: { en: "\"Code is my voice. Innovation is my language. Impact is my legacy.\"", pt: "\"Código é minha voz. Inovação é minha linguagem. Impacto é meu legado.\"", es: "\"El código es mi voz. La innovación es mi lenguaje. El impacto es mi legado.\"" },
  ...
  about_desc_1: { 
    en: "It started early. At 13, while others played, I was already coding, fueled by an OBMEP classification and a hunger to build. I never stopped. By 19, that relentless drive earned me approvals for 4 international exchanges, including Data Science studies in London at Bayswater College.", 
    pt: "Começou cedo. Aos 13 anos, enquanto outros brincavam, eu já codificava, impulsionado por uma classificação na OBMEP e uma fome de construir. Nunca parei. Aos 19, essa determinação implacável me garantiu aprovações em 4 intercâmbios internacionais, incluindo estudos de Data Science em Londres na Bayswater College.", 
    es: "Empezó temprano. A los 13 años, mientras otros jugaban, yo ya codificaba, impulsado por una clasificación en la OBMEP y hambre de construir. Nunca paré. A los 19, esa determinación implacable me aseguró aprobaciones en 4 intercambios internacionales, incluyendo estudios de Data Science en Londres en Bayswater College." 
  },
  about_desc_2: { 
